...
```mermaid
flowchart TD
    A["0:00 - Arrival<br/>Ruined Grand Ballroom, silent music, Alistair frozen in stone"] --> B["0:30 - Touch the statue<br/>A faint Bachata count starts under the floor"]
    B --> C["1:00 - Guided solo phrase<br/>Drag Basic Side-Step into Bar A"]
    C --> D["2:00 - Complete the 8-count<br/>Basic Side-Step + Basic Side-Step + Head Accent"]
    D --> E["3:00 - Beat 8 payoff<br/>Head Accent lands, stone cracks across Alistair"]
    E --> F["4:00 - Dawn growth<br/>Ballroom floor clears, Beginner Confidence I unlocks"]
    F --> G["6:00 - Alistair wakes<br/>He explains that sustained dance can break the curse"]
    G --> H["8:00 - Day 2 preparation<br/>Choose Train Technique + Rehearse Cards"]
